...
\begin{frame}[fragile]
    \begin{columns}[t]
        ...
        \begin{column}{\colwidth}
            ...
            \begin{block}{Textbook Formulations}
                ...
                In proving the Hyperplane Separation Theorem, two widely-known theorems were crucial: the \textbf{ Heine-Borel Theorem}, and the existence of an infimum on a compact set. The Mathlib statements of each are outlined below. 
            \end{block}
...
\vspace{1em}
            ...
            \begin{block}{A preliminary sample proof}
            \vspace{-0.5em}
\begin{Verbatim}
